...
{
    public class ShowListQuery : IQuery
    {
        private const string Endpoint = "http://www.giantbomb.com/api/video_shows/?api_key={0}&format=json&{1}";
        ...
        public ShowListQuery(string fieldList=null, int limit=100, int offset=0, string sort=null)
        {
